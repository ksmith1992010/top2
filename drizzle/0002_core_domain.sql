...
CREATE TYPE "public"."job_status" AS ENUM('lead', 'inspection_scheduled', 'inspection_complete', 'claim_filed', 'adjuster_meeting_scheduled', 'approved', 'contract_signed', 'material_ordered', 'production_scheduled', 'installed', 'invoiced', 'paid', 'closed');--> statement-breakpoint
